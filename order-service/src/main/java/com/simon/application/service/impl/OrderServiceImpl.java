...
import com.simon.application.client.UserServiceClient;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderServiceImpl(OrderRepository orderRepository, UserServiceClient userServiceClient, EventPublisher eventPublisher) {
    ...
    public OrderResponse createOrder(CreateOrderRequest request, Long customerId) {
        ...
        userServiceClient.assertCustomerExists(customerId);
    ...
    public OrderSummaryResponse getOrderSummary(Long id) {
        return OrderMapper.toSummaryResponse(findOrderEntityById(id));
    }
